...
^http:\/\/(mgxhtj|nmobi|searchrecterm)\.kuwo\.cn\/(mgxh|mobi|recterm)\.s url script-response-body https://raw.githubusercontent.com/Midnight0716/Qx/main/Scripts/break/kuwo.js

# 会员
^http:\/\/audiobookpay\.kuwo\.cn\/a\.p url script-response-body https://raw.githubusercontent.com/Midnight0716/Qx/main/Scripts/break/kuwo.js
^http:\/\/musicpay\.kuwo\.cn\/music\.pay url script-response-body https://raw.githubusercontent.com/Midnight0716/Qx/main/Scripts/break/kuwo.js
^http:\/\/vip1\.kuwo\.cn\/vip\/(enc\/user\/vip\?op=ui|v2\/theme\?op=gd) url script-response-body https://raw.githubusercontent.com/Midnight0716/Qx/main/Scripts/break/kuwo.js
^https:\/\/vip1\.kuwo\.cn\/vip\/v2\/user\/vip\?op=ui url script-response-body https://raw.githubusercontent.com/Midnight0716/Qx/main/Scripts/break/kuwo.js
...
if (url.includes("/a.p")) {
  ...
  obj.data = {
    ...
    luxAutoPayUser: "2",
    biedAlbum: "1",
    vipLuxuryExpire: "4102362000000",
    vipmAutoPayUser: "2",
    svipAutoPayUser: "2",
    vipExpire: "4102362000000",
    svipExpire: "4102362000000"
  };
  body = JSON.stringify(obj);
